const Body = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-green-50 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-500/10 via-blue-500/5 to-green-500/10"></div>
      </div>

      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
